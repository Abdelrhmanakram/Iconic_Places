...
<head>
  <meta charset="UTF-8">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <link rel="stylesheet" href="wedd.css">
...
<div class="maintext">
      <p>We aim to save your efforts finding a place bring love and light to your wedding day</p>
...
<figcaption> <h2><?php echo $row['name'];?></h2> <h5><?php echo $row['descr'];?> </h5><h3>Price:<?php echo $row['price'];?></h3>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    .btn {
     ...
     <input type="text" name="name" placeholder="Full Name" class="namee" required title="Please fill out this field"> <br> <br>
     <input type="email" name="email" placeholder="Email" class="namee" required title="Please fill out this field"> <br><br>
     <input type="tel" name="phone" placeholder="Phone Number" class="namee" required title="Please fill out this field"> <br><br>
     <input type="number" name="capacity" placeholder="no. of person" class="namee" required title="Please fill out this field"> <br><br>
  ...
  <label for="to">To</label> 
     ...
     <input type="text" name="note" placeholder="place's name" class="namee"> 
       ...
       <button type="submit" name="wedd" class="btn" > BookNow</button>
...
$opt=$_POST['sorting'];
if ($opt=="low") {
$qq="select * from `wedding` order by `price` ASC";
...
$qq="select * from `wedding` order by `price` DESC";
$re=mysqli_query($conn,$qq);
while ($row=mysqli_fetch_array($re)) {
?>
...
$qq="select * from `wedding` WHERE `name`LIKE'%$opt%'";
$re=mysqli_query($conn,$qq);
while ($row=mysqli_fetch_array($re)) {
?>
