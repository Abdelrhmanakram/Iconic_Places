...
<div class="maintext">
      <p>Helping you find a place for your event that will leave a lasting impression</p>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <label for="to">To</label> 
     ...
     <input type="text" name="note" placeholder=" Place's Name" class="namee"> 
       ...
       <button   type="submit" name="event" class="btn" >Book Now</button>
...
$opt=$_POST['sorting'];
if ($opt=="low") {
$qq="select * from `events` order by `price` ASC";
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <label for="to">To</label> 
     ...
     <input type="text" name="note" placeholder=" Place's Name" class="namee"> 
	   ...
	   <div class="model-footer">
       <button type="submit" name="event" class="btn" > BookNow</button>
       <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
</form>
...
$qq="select * from `events` order by `price` DESC";
$re=mysqli_query($conn,$qq);
while ($row=mysqli_fetch_array($re)) {
?>
...
$qq="select * from `events` WHERE `name`LIKE'%$opt%'";
$re=mysqli_query($conn,$qq);
while ($row=mysqli_fetch_array($re)) {
?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <label for="to">To</label> 
     ...
     <input type="text" name="note" placeholder=" Place's Name" class="namee"> 
	   ...
	   <div class="model-footer">
       <button href="server.php"  type="submit" name="event" class="btn" > BookNow</button>
       <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
</form>
